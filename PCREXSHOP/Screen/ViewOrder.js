...
const OrderHistoryCard = ({ order }) => {
    ...
    return (
        <View style={styles.card}>
            ...
            {order.items.map(item => <OrderItem key={item.id || item._id} item={item} />)}
            ...
            <FlatList
                ...
                ListEmptyComponent={
                    <View style={styles.emptyContainer}>
                        <Icon name="card-off" size={70} color="#CCC" />
...
const styles = StyleSheet.create({
    ...
    orderStatus: { fontSize: 14, marginLeft: 6, fontFamily: 'Rubik-Bold' },
    orderDate: { fontSize: 13, color: '#868E96', fontFamily: 'Rubik-Regular' },
    ...
    orderItemName: { fontSize: 15, color: '#343A40', fontFamily: 'Rubik-SemiBold' },
    orderItemQuantity: { fontSize: 14, color: '#868E96', marginTop: 4, fontFamily: 'Rubik-Regular' },
    orderItemPrice: { fontSize: 15, color: '#495057', fontFamily: 'Rubik-Medium' },
    ...
    totalLabel: { fontSize: 14, color: '#495057', fontFamily: 'Rubik-Regular' },
    totalValue: { fontSize: 18, marginLeft: 8, color: '#074ec2', fontFamily: 'Rubik-SemiBold' },
    emptyContainer: { flex: 1, justifyContent: 'center', alignItems: 'center', paddingTop: 100 },
    emptyText: { marginTop: 20, fontSize: 17, color: '#ADB5BD', fontFamily: 'Rubik-Regular' },
});
