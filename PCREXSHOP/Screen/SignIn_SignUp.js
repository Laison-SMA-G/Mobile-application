    ...
    <SafeAreaView style={styles.container}>
        ...
        <View style={styles.innerContainer}>
          ...
          <View style={styles.formWrapper}>
            ...
            >
              ...
              {loading ? null : <Text style={styles.buttonText}>{isLogin ? "Sign In" : "Sign Up"}</Text>}
            </TouchableOpacity>
      ...
      >
        <Pressable style={styles.modalOverlay} onPress={() => setAlertModalVisible(false)}>
          <Pressable
            style={[styles.alertModalContainer, { backgroundColor: alertConfig.isSuccess ? "#4BB543" : "#E31C25" }]}
          >
            <Icon
