            ...
            <FlatList
                ...
                ListEmptyComponent={
                    <View style={styles.emptyContainer}>
                        <Icon name="truck-delivery-outline" size={50} color="#888" />
                        <Text style={styles.emptyText}>No orders to receive</Text>
                    </View>
                }
                contentContainerStyle={toReceiveOrders.length === 0 && styles.emptyList}
            />
        </SafeAreaView>
    );
};
