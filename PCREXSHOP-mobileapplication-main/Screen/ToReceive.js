  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <FlatList
        ...
        renderItem={({ item }) => <OrderCard order={item} onConfirm={() => handleConfirmReception(item._id)} />}
          ...
          <Pressable style={styles.alertModalContainer}>
            ...
            <View style={styles.modalActions}>
              ...
              <TouchableOpacity style={[styles.modalButton, styles.modalPrimaryButton]} onPress={() => { confirmConfig.onConfirm(); setConfirmModalVisible(false); }}>
                <Text style={styles.modalButtonTextPrimary}>Yes, I've Received It</Text>
              </TouchableOpacity>
            </View>
          </Pressable>
        </Pressable>
...
const styles = StyleSheet.create({
  ...
  orderStatus: { fontSize: 13, color: '#2ECC71' },
