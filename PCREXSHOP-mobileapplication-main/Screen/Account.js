...
import { getImageUri } from '../utils/getImageUri'; // Add this
...
const Account = ({ navigation }) => {
    ...
    const handleLogout = () => setConfirmModalVisible(true);
    ...
    const profileImageUri = displayUser.profileImage ? getImageUri(displayUser.profileImage) : null;
    ...
    return (
        <SafeAreaView style={styles.safeArea}>
            ...
            <Modal animationType="fade" transparent={true} visible={isLogoutSuccessVisible}>
...
const styles = StyleSheet.create({
    ...
    scrollViewContent: { flex: 1, backgroundColor: '#FAFAFA' },
    ...
    avatar: { width: 100, height: 100, borderRadius: 50, backgroundColor: '#E0E0E0', marginBottom: 12, borderWidth: 2, borderColor: '#074ec2' },
    avatarPlaceholder: { width: 100, height: 100, borderRadius: 50, backgroundColor: '#EAEAEA', marginBottom: 12, justifyContent: 'center', alignItems: 'center', borderWidth: 2, borderColor: '#B0B0B0' },
    ...
    orderStatusText: { marginTop: 6, fontSize: 12, color: '#555', fontFamily: 'Rubik-Regular', textAlign: 'center' },
    actionsSection: { paddingHorizontal: 20, marginBottom: 20 },
    actionButton: { flexDirection: 'row', alignItems: 'center', paddingVertical: 15, paddingHorizontal: 0, borderRadius: 0, width: '100%', marginBottom: 0 },
    actionButtonText: { fontSize: 16, color: '#1C1C1C', marginLeft: 15, fontFamily: 'Rubik-Medium', flex: 1 },
    arrowIcon: { marginLeft: 'auto' },
    logoutButton: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#FFFFFF', paddingVertical: 15, paddingHorizontal: 20, borderRadius: 15, width: '45%', alignSelf: 'center', marginTop: 20, borderWidth: 1, borderColor: '#EAEAEA', shadowColor: "#000", shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.1, shadowRadius: 3.84, elevation: 5 },
    logoutButtonText: { fontSize: 16, color: '#E31C25', marginLeft: 15, fontFamily: 'Rubik-SemiBold' },
    ...
    toastContainer: { backgroundColor: '#E31C25', borderRadius: 10, paddingVertical: 15, paddingHorizontal: 25, alignItems: 'center', elevation: 5 },
